...
import { Sparkles, ShoppingBag, Zap, Sun, Moon } from 'lucide-react';
...
const ShopLogin = () => {
  ...
  return (
    <>
      <SEO
        title="Sign In | NanoFlows Digital Hub"
        description="Sign in to NanoFlows Digital Hub to access your account, orders, and digital products."
        keywords="digital hub login, sign in, digital hub account"
      />
        ...
        <div className="hidden lg:flex flex-col justify-center items-start p-12 xl:p-16">
          ...
          >
            ...
            <p className={`text-lg mb-8 leading-relaxed ${currentTheme.classes.text}`}>
              Discover amazing digital products, software tools, and exclusive deals. 
              Shop smarter with personalized recommendations, secure checkout, and instant digital delivery.
            </p>

            {/* Features List */}
            <div className="space-y-4">
              {[
                { icon: ShoppingBag, text: 'Exclusive Deals & Digital Products' },
                { icon: Zap, text: 'Instant Digital Delivery & Secure Checkout' },
                { icon: Sparkles, text: 'Personalized Recommendations & Wishlist' }
              ].map((feature, idx) => (
                <motion.div
                  key={idx}
        ...
        <div className="flex items-center justify-center p-4 sm:p-8 lg:p-12">
          ...
          <div className="mb-6 text-center">
            ...
            <p className={`mt-1 text-xs ${currentTheme.classes.text}`}>
              Sign in to access your shopping account, orders, wishlist, and exclusive deals
            </p>
          </div>
