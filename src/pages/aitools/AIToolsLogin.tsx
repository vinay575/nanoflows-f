...
const AIToolsLogin = () => {
  ...
  const { user, login } = useAIToolsAuth();
  ...
  useEffect(() => {
    if (isAuthenticated) {
      const from = (location.state as any)?.from?.pathname || '/ai-tools';
        ...
        <div className="hidden lg:flex flex-col justify-center items-start p-12 xl:p-16">
          ...
          >
            ...
            <p className={`text-lg mb-8 leading-relaxed ${currentTheme.classes.text}`}>
              ...
              Access Academy courses, AI Tools platform, and transform your career with practical, industry-relevant skills.
            </p>
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Zap, text: 'Hands-On Projects & Real-World Applications' },
                { icon: Sparkles, text: 'Industry-Recognized Certificates & AI Tools Access' }
              ].map((feature, idx) => (
                <motion.div
                  key={idx}
        ...
        <div className="flex items-center justify-center p-4 sm:p-8 lg:p-12">
          ...
          <div className="mb-6 text-center">
            ...
            <p className={`mt-1 text-xs ${currentTheme.classes.text}`}>
              Sign in to access Academy courses, AI Tools platform, and your personalized learning dashboard
            </p>
          </div>
